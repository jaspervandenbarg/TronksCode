...
public class FollowEnemy : EnemyAI
{
    ...
    protected override void EnemyBehaviour()
    {
        ...
        if (inBulletPath)
            EvadeBullet();
        else if (!entity.FieldOfView.playerVisible && (DestinationReached() || !targetLost))  //dit moet anders zodat hij steeds blijft zoeken tot de player gevonden is
